...
/* Compte le nombre d'ordinateurs d'un site
  param : id du site
*/
...
/* Compte le nombre de matériels d'un site (ordinateurs + périphériques + téléphones)
  param : id du site
*/
...
/* Compte le nombre de logiciels install??s sur un ordinateur
  param : id ordinateur
  retourne un entier.
*/
...
/* Compte le nombre de ports actifs d'un équipement réseau.
	param : id équipement
	retourne un entier.
*/
...
/*Reconstruit le chemin complet d'un niveau (racine -> feuille).
	param : id du hierarchy_level
	retourne la chaine "Racine > Niveau1 > ... > Cible" (NULL si introuvable).
*/
