...
BEGIN
	-- Verifier que le hierarchy_level existe et recuperer son site
	BEGIN
	...
	-- Verifier la coherence site/hierarchy_level
	...
	-- Verifier l'unicite du numero de serie sur le site
...
*/
-- Demontre la gestion de DUP_VAL_ON_INDEX.
